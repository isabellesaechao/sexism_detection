...
model_path = "../D3_models/trained_pseudo_model_4way"
model = DistilBertForSequenceClassification.from_pretrained(model_path)
model.to(device)

# Load the dataset
data_path = "../../data/preprocessed_4way_data_aggregated.csv"
...
# Create a new column with the updated 4-way classification labels
label_map = {
...
df_sexist['new_label'] = df_sexist['label_category'].apply(lambda x: label_map[x])
...
outputDF.to_csv("../pseudo_outputs/4_way_output")
